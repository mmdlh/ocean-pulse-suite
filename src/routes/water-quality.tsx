...
function WaterQualityPage() {
  const phGauge = {
    ...
    series: [{
      ...
      pointer: { length: "60%", width: 6, itemStyle: { color: "#22d3ee" } },
      progress: { show: true, width: 14, itemStyle: { color: { type: "linear", x: 0, y: 0, x2: 1, y2: 0, colorStops: [{ offset: 0, color: "#0891b2" }, { offset: 1, color: "#22d3ee" }] } } },
      axisLine: { lineStyle: { width: 14, color: [[0.3, "#ef4444"], [0.5, "#fbbf24"], [0.7, "#22d3ee"], [1, "#a78bfa"]] } },
      axisTick: { show: false },
      splitLine: { length: 8, lineStyle: { color: "#475569", width: 2 } },
      axisLabel: { color: "#94a3b8", distance: 20, fontSize: 11 },
      detail: { valueAnimation: true, fontSize: 28, fontFamily: "Orbitron", color: "#22d3ee", offsetCenter: [0, "70%"], formatter: "{value}" },
  ...
  const doGauge = {
    ...
    series: [{
      ...
      pointer: { length: "60%", width: 6, itemStyle: { color: "#2dd4bf" } },
      progress: { show: true, width: 14, itemStyle: { color: { type: "linear", x: 0, y: 0, x2: 1, y2: 0, colorStops: [{ offset: 0, color: "#0d9488" }, { offset: 1, color: "#2dd4bf" }] } } },
      axisLine: { lineStyle: { width: 14, color: [[0.3, "#ef4444"], [0.5, "#fbbf24"], [0.7, "#2dd4bf"], [1, "#22d3ee"]] } },
      axisTick: { show: false },
      splitLine: { length: 8, lineStyle: { color: "#475569", width: 2 } },
      axisLabel: { color: "#94a3b8", distance: 20, fontSize: 11 },
      detail: { valueAnimation: true, fontSize: 28, fontFamily: "Orbitron", color: "#2dd4bf", offsetCenter: [0, "70%"], formatter: "{value} mg/L" },
  ...
  const realtimeLine = {
    ...
    series: [
      { name: "pH值", type: "line", smooth: true, data: Array.from({ length: 24 }, () => (7 + Math.random() * 1.5).toFixed(1)), lineStyle: { color: "#22d3ee", width: 2 }, itemStyle: { color: "#22d3ee" }, symbol: "none" },
      { name: "溶解氧", type: "line", smooth: true, data: Array.from({ length: 24 }, () => (6 + Math.random() * 4).toFixed(1)), lineStyle: { color: "#2dd4bf", width: 2 }, itemStyle: { color: "#2dd4bf" }, symbol: "none" },
  ...
  const stackedBar = {
    ...
    yAxis: { ...baseChartOption.yAxis, type: "value" },
    series: [
      { name: "氨氮", type: "bar", stack: "total", data: [0.5, 0.8, 0.3, 1.2, 0.6], itemStyle: { color: { type: "linear", x: 0, y: 0, x2: 0, y2: 1, colorStops: [{ offset: 0, color: "#22d3ee" }, { offset: 1, color: "#0891b2" }] }, borderRadius: [0, 0, 0, 0] } },
