  ...
  const pollutionTypePie = {
    ...
    series: [{
      ...
      data: [
        ...
        { value: 12, name: "塑料垃圾", itemStyle: { color: "#4f6bf6" } },
  ...
  const regionBar = {
    ...
    series: [{
      ...
      data: [
        ...
        { value: 18, itemStyle: { color: { type: "linear", x: 0, y: 0, x2: 1, y2: 0, colorStops: [{ offset: 0, color: "#4f6bf6" }, { offset: 1, color: "#3b5ce5" }] }, borderRadius: [0, 6, 6, 0] } },
        { value: 10, itemStyle: { color: { type: "linear", x: 0, y: 0, x2: 1, y2: 0, colorStops: [{ offset: 0, color: "#6b8afc" }, { offset: 1, color: "#4a6ae0" }] }, borderRadius: [0, 6, 6, 0] } },
      ],
    }],
  };
